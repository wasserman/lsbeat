...
```
git remote set-url origin https://github.com/wasserman/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/wasserman
cd ${GOPATH}/github.com/wasserman
git clone https://github.com/wasserman/lsbeat
```
